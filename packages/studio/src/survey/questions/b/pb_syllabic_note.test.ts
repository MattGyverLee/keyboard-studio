...
import { validate, fixtures } from "./pb_syllabic_note.ts";

describe("pb_syllabic_note — validate() valid fixtures", () => {
...
describe("pb_syllabic_note — validate() invalid fixtures", () => {
...
describe("pb_syllabic_note — validate() edge cases", () => {
