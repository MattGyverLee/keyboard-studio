...
import { validate, fixtures } from "./pb_indic_vowels_separate.ts";

describe("pb_indic_vowels_separate — validate() valid fixtures", () => {
...
describe("pb_indic_vowels_separate — validate() invalid fixtures", () => {
...
describe("pb_indic_vowels_separate — validate() edge cases", () => {
