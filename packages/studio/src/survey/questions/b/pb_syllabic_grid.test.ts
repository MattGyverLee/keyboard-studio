...
import { validate, fixtures } from "./pb_syllabic_grid.ts";

describe("pb_syllabic_grid — validate() valid fixtures", () => {
...
describe("pb_syllabic_grid — validate() invalid fixtures", () => {
...
describe("pb_syllabic_grid — validate() edge cases", () => {
