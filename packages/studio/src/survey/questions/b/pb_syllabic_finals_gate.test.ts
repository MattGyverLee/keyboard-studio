...
import { validate, fixtures } from "./pb_syllabic_finals_gate.ts";

describe("pb_syllabic_finals_gate — validate() valid fixtures", () => {
...
describe("pb_syllabic_finals_gate — validate() invalid fixtures", () => {
...
describe("pb_syllabic_finals_gate — validate() edge cases", () => {
