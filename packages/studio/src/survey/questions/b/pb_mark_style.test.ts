...
import { validate, fixtures } from "./pb_mark_style.ts";

describe("pb_mark_style — validate() valid fixtures", () => {
...
describe("pb_mark_style — validate() invalid fixtures", () => {
...
describe("pb_mark_style — validate() edge cases", () => {
