...
import { validate, fixtures } from "./pb_stacking_marks.ts";

describe("pb_stacking_marks — validate() valid fixtures", () => {
...
describe("pb_stacking_marks — validate() invalid fixtures", () => {
...
describe("pb_stacking_marks — validate() edge cases", () => {
  it("rejects 'maybe'", () => {
