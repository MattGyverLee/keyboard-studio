...
import { validate, fixtures } from "./pb_digit_set.ts";

describe("pb_digit_set — validate() valid fixtures", () => {
...
describe("pb_digit_set — validate() invalid fixtures", () => {
...
describe("pb_digit_set — validate() edge cases", () => {
