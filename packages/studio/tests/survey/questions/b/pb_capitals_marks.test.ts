...
import { validate, fixtures } from "./pb_capitals_marks.ts";

describe("pb_capitals_marks — validate() valid fixtures", () => {
...
describe("pb_capitals_marks — validate() invalid fixtures", () => {
...
describe("pb_capitals_marks — validate() edge cases", () => {
