...
import { validate, fixtures } from "./pb_rtl_short_vowels.ts";

describe("pb_rtl_short_vowels — validate() valid fixtures", () => {
...
describe("pb_rtl_short_vowels — validate() invalid fixtures", () => {
...
describe("pb_rtl_short_vowels — validate() edge cases", () => {
